const select = document.getElementById("data-istqb3");
const link = document.getElementById("istqb3-link");

const firstData = "jeden";  
const secondData = "dwa"; 
const thirdData = "trzy"; 
